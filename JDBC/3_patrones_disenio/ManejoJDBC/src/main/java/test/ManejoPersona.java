...
public class ManejoPersona {
 ...
 public static void main(String[] args) {
  ...
  try
  {
   ...
   PersonaDTO personaEditar = new PersonaDTO(1, "Miguel", "Cuatro", "miguelcuatromejia@java.com", "70377081");
   personaDAO.actualizar(personaEditar);

   PersonaDTO personaInsertar = new PersonaDTO("Fernando Miguel", "Cuatro Rivera", "fernando@java.com", "64220098979700");
