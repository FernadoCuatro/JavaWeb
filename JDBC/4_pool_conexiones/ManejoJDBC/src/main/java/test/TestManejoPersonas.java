 ...
 public static void main(String[] args) {
  ...
  switch (opcion)
  {
   ...
   case 2:
    ...
    PersonaDTO personaInsertar = new PersonaDTO(nombre, apellido, email, telefono);
   ...
   case 3:
    ...
    PersonaDTO personaActualizar = new PersonaDTO(idEditar, nombre, apellido, email, telefono);
   ...
   case 4:
    ...
    PersonaDTO personaEliminar = new PersonaDTO(idEliminar);
