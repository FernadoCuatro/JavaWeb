...
public class ClienteDaoJDBC {
    ...
    private static final String SQL_UPDATE = "UPDATE clientes SET cliente_nombre=?, cliente_apellido=?, cliente_email=?, cliente_telefono=?, cliente_saldo=? WHERE cliente_id=?";
